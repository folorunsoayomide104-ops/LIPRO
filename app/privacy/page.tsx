  ...
  return (
    <div>
      ...
      <main className="mx-auto max-w-3xl px-4 py-16 prose prose-headings:tracking-tight">
        ...
        <p>LIPRO AI and the CBT question generator are powered by a third-party AI provider (currently NVIDIA, using either your own personal API key added in Settings or a shared app key). When you upload a document, ask LIPRO AI a question, or generate practice questions, the relevant text — and, for scanned documents, page images used for text recognition — is sent to this provider&apos;s API to produce a response. The provider processes the content to generate a reply but does not have standing access to your account or other stored data. Do not upload documents containing information you are not permitted to share outside your institution.</p>
        <h2>4. Payments</h2>
