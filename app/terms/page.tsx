  ...
  return (
    <div>
      ...
      <main className="mx-auto max-w-3xl px-4 py-16 prose prose-headings:tracking-tight">
        ...
        <h2>1. Acceptance</h2>
        <p>By creating an account on LIPRO you agree to these terms. If you do not agree, do not use the platform.</p>
        <h2>2. Eligibility</h2>
        <p>LIPRO is designed for students, lecturers and administrators of Nigerian universities. You must provide accurate academic information during registration.</p>
        ...
        <p>Course materials remain the property of their authors. Your personal notes remain yours. LIPRO holds a limited license to display content for the purpose of providing the service.</p>
        <h2>8. Limitation of liability</h2>
        <p>LIPRO is provided &quot;as is&quot;. We are not liable for academic outcomes resulting from AI-assisted study.</p>
        <h2>9. Governing law & dispute resolution</h2>
        <p>These terms are governed by the laws of the Federal Republic of Nigeria. Any dispute arising from your use of LIPRO that cannot be resolved informally will first be referred to mediation, and failing that, settled by arbitration under the Arbitration and Conciliation Act, seated in Nigeria, rather than through court litigation or class action, except where applicable law does not permit this.</p>
        <h2>10. Changes</h2>
